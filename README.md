...
- [Open-Source Toolbox for Object Detection Metrics](#open-source-toolbox-for-object-detection-metrics)
  ...
  - [Metrics](#metrics)
    ...
    - [AR<sub>1</sub>, AR<sub>10</sub> and AR<sub>100</sub>](#artextsubscript1-artextsubscript10-and-artextsubscript100)
    - [AR<sub>S</sub>, AR<sub>M</sub> and AR<sub>L</sub>](#artextsubscripts-artextsubscriptm-and-artextsubscriptl)
